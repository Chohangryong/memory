...
- [project_bumoro.md](project_bumoro.md) — **부모로(Bumoro) Phase 1 착수 전 단계(2026-05-08)**. Next.js 15+Supabase. 데이터조사 완료(API 6806건+서울25구 크롤링). benefits 스키마 합의(region_code 5자리/income_min_max_pct/amount_tiers jsonb/matchable). 매칭=Supabase SQL 필터(외부엔진 불필요). 미완료: 마이그레이션 파일·임포트 파이프라인·매칭 API·user_benefits 테이블
